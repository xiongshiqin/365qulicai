...
<div class="clearfix">
    <div class="fl">
        ...
        <a href="<?php echo $this->createUrl('/news/check');?>" class="btn">新闻审核</a>
        ...
        <tbody>
        	<?php foreach($news as $key=>$value){?>
                <tr>
                    ...
                    <td><?php echo Yii::app()->params['News']['category'][2][$value->classid]?></td>
                    <td><?php echo date('Y-m-d H:i:s',$value->dateline)?></td>
                    <td><a href="<?php echo $this->createUrl('edit',array('newsid'=>$value->newsid))?>">编辑</a><span><?php if($value->status == 0) echo "&nbsp;&nbsp;&nbsp;&nbsp;未审核";?></span></td>             
                 </tr>
            <?php }?>
        </tbody>
    </thead>

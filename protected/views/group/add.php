	...
	<div class="contentR">
		...
		<div class="mainarea">
			...
			<div class="block fatie">
				<form id="form1" name="form1" method="post" action="<?php echo $this->createUrl('group/add', array('gid'=>$this->_group->gid)); ?>" >
					<input type="hidden" name="gid" value="<?php echo $this->_group->gid; ?>" />
					<table width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
						<tr>
							<td width="8%" >标题：</td>
							<td width="92%"><input style="width:664px;" type="text" name="title" id="textfield" /></td>
						</tr>
						<tr>
